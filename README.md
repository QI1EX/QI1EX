...
- Знаю математику для анализа данных: математическую статистику, теорию вероятностей
- Освоены фундаментальные знания математики: математический анализ, линейная алгебра, методы оптимальных решений
